...
% TODO: Referenciar los 5 criterios y la puntuacion 0-10 y 50
Para cada instancia, el modelo evaluador analizó ambas descomposiciones y asignó puntuaciones en cinco criterios: coherencia, completitud, viabilidad, formato y granularidad. Cada criterio fue evaluado en una escala de 0 a 10, obteniéndose una puntuación total máxima de 50 puntos. Este enfoque multidimensional permite descomponer el concepto de calidad en atributos observables, evitando reducciones simplificadas basadas únicamente en similitud textual.

La coherencia evaluó la correspondencia semántica entre las tareas generadas y la historia de usuario original. La completitud midió el grado de cobertura de los requerimientos implícitos y explícitos. La viabilidad analizó si las tareas propuestas eran técnicamente realizables. El criterio de formato verificó la estructura y claridad de la salida, mientras que la granularidad evaluó la adecuación del nivel de descomposición. Este tipo de evaluación estructurada es consistente con enfoques recientes que destacan la necesidad de considerar la ambigüedad inherente en tareas subjetivas y su impacto en la validación de sistemas LLM-as-a-Judge \cite{guerdan2025llmjudge}.

% TODO: Referenciar el umbral de aprobacion y la validacion humana
Se estableció un umbral de aprobación de 35 puntos, 70\% del máximo, considerando que este valor representa un nivel aceptable de cumplimiento de los criterios definidos. Además de la puntuación total, el sistema registró métricas parciales y un indicador de aprobación para cada instancia, lo que permitió realizar análisis comparativos entre los generadores.
